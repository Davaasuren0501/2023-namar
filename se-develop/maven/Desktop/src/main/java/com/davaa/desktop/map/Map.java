...
public class Map
{
    ...
    public static void main(String[] args)
    {
        ...
        GeoPosition frankfurt = new GeoPosition(App.latitude, App.longitude);
    ...
    protected static void updateWindowTitle(JFrame frame, JXMapViewer mapViewer)
    {
        ...
        frame.setTitle(String.format("JXMapviewer2 Example 3 (%.2f / %.2f) - Zoom: %d", App.latitude, App.longitude, zoom));
    }
